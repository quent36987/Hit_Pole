    ...
    return (<>
        {load && items ?
            <div>
                ...
                <button
                    style={{ fontSize: "20px", marginBottom: "20px", borderRadius: "5px", border: "1px solid #ccc", color: "#000", width: "85vw", marginRight: "20px", marginLeft: "20px", marginTop: "10px" }}
                    onClick={handleShow1}>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body> {modalNewUser ?
                        <Forms calendrierID={items.id} cb={() => {
                            handleClose();
                            getAllUsersFirebase().then((data) => {
                                setusers(data);
                                LoadData();
